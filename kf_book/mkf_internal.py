...
def plot_all(ps, actual, zs, cov, std_scale=1,
    ...
    bp.plot_track(actual, c='red')
    bp.plot_measurements(range(1, count + 1), zs, color='blue')
    bp.plot_filter(range(1, count + 1), ps, c='green')
